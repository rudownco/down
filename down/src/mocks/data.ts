...
// Translated from ios/down/MockData/MockData.swift

import { DownGroup, EventSuggestion, RSVP, User, VotingOption } from '../types';
...
/** Get mock events for a group */
export function getMockEventsForGroup(groupId: string): EventSuggestion[] {
  switch (groupId) {
    case 'g1':
      return [MockEvents.pizzaNight, MockEvents.movieMarathon];
    case 'g3':
      return [MockEvents.gamingSession, MockEvents.coffeeRun, MockEvents.pizzaNight];
    default:
      return [MockEvents.coffeeRun];
  }
}
